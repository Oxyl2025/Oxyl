...
<html lang="id">
  ...
  <body>
    <!-- Header & Navigation -->
    <header>
      <a href="#" class="logo">OXYL <span></span></a>
      <nav>
        <ul>
      ...
      <div class="products-grid">
        <div class="product-card">
          ...
          <div class="product-image">
            <img src="2.jpg" alt="Noir Élégant" />
          </div>
        ...
        <div class="product-card">
          ...
          <div class="product-info">
            ...
            <h3 class="product-title">Velvet Bloum</h3>
            <p class="product-description">
        ...
        <div class="product-card">
          ...
          <div class="product-info">
            ...
            <p class="product-description">
              ...
              memiliki Karakter Hangat, cream
            </p>
            <div class="product-footer">
              <span class="product-price">Rp 140.000</span>
              <span class="product-rating">
                <i class="fas fa-star"></i>
                <i class="fas fa-star"></i>
                <i class="fas fa-star"></i>
    ...
    <section id="harga" class="section" style="background-color: #fafafa">
      <div class="section-title">
        <h2>Daftar Harga</h2>
        <p>Pilih ukuran yang sesuai dengan kebutuhan Anda</p>
      </div>
    ...
    <section id="tentang" class="section">
      <div class="about-container">
        ...
        <div class="about-content">
          ...
          <p>
            Didirikan oleh mahasiswa dari Universitas UDINUS Fakultas FEB yang memiliki ketertarikan
